...
int solve()
{
    ...
    cin >> n;
    // if n is odd
    // impossible to find [a, a+1] where both are factors of n  (one of them is even)

    // if n not divisible by 3, then 3 is impossible
    // is 2 always possible? yes - choose 1,2

    // if k is first pos number that is not a factor of n
    // k-1 is possible (choose 1, k-1)
    // k is impossible
